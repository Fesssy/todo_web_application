...
if (loggedin()) {
    header("location:home.php"); // Redirecting to home.php if there is already a user logged in
}
?>
                ...
                <table>
                    <tbody>
                        <tr>
                            ...
                            <td> <input size="25" type="text" name="username" placeholder="Imran" autocomplete="off" required></td>
                        </tr>
                        <tr>
                            <td>
                                <pre>Password </pre>
